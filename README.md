...
IBE decryption and vetKey verification — the whole canister-side path this PoC's
Rust canister uses, with no functional gap left between them. It costs about 5.4
billion instructions cold (verify plus decrypt) against the 40 billion an update
call gets, and it is paid once.
